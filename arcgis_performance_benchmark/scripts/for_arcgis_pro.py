# -*- coding: utf-8 -*-
"""
ArcGIS Pro Python 窗格测试脚本
在 ArcGIS Pro 的 Python 窗格中执行此脚本
"""
import arcpy
import time
import json
...
# 输出文件路径
output_file = os.path.join(project_path, "results", "raw", "benchmark_results_arcgis_pro.json")
...
print("=" * 60)
print("ArcGIS Pro Python 窗格性能测试")
print("=" * 60)
print("ArcGIS Pro Version: {}".format(arcpy.GetInstallInfo()['Version']))
...
with open(output_file, 'w') as f:
    json.dump({
        'test_type': 'ArcGIS_Pro_Python_Pane',
